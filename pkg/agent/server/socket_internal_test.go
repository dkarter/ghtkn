...
func TestCleanupStaleSocket(t *testing.T) {
	t.Parallel()
	t.Run("no file", testCleanupNoFile)
	t.Run("stale socket removed", testCleanupStaleSocketRemoved)
	t.Run("regular file preserved", testCleanupRegularFilePreserved)
	t.Run("symlink preserved", testCleanupSymlinkPreserved)
}
...
func testCleanupStaleSocketRemoved(t *testing.T) {
	t.Parallel()
...
func testCleanupRegularFilePreserved(t *testing.T) {
	t.Parallel()
...
func testCleanupSymlinkPreserved(t *testing.T) {
	t.Parallel()
	dir := t.TempDir()
